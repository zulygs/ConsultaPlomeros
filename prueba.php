            ...
            <div class="formArea">
              ...
              <div class="form">
               <!-- <div class="col form-group col-md-5">
                  <input type="number" name="inm_id" id="inm_id" class="form-control" placeholder="ID Inmueble" >
                </div>-->
                <div class="col form-group col-md-5">
                      ...
                      <?php } else if($alert==2){?>
                        <p class="alert alert-success alert-dismissible" role="alert" >
                          <font color="#3c763d">¡La solicitud 
                            <font color="black"><?php echo ($sol_id); ?></font> 
                            se resolvió el <?php echo fechaCastellano($hora4_); ?>!
                          </font>
                        </p>
                      <?php } ?>
                    </font>
              ...
              <div class="stl_body">
                ...
                <div class="padding">
                    ...
                    <div class=" stl_event done event-1 first">
                      ...
                      <div class="tl-dot">
                       <img src="https://img.icons8.com/color/30/000000/ok--v1.png"/>
                      </div>
                      <div class="text">
