...
if (!isset($_SESSION['active'])) {
    ...
    $queryy     = "SELECT * from tblPlomeros where PLO_ID=47";
...
<body>
    <div class="container">
       ...
       <center><h2>Solicitudes De Servicios Por Plomero <img src="gotita.png" width="100px"></h2></center>
       <div ><center><h5><?php echo $Nombre . " " . $Apellido ?></h5></center></div>
    ...
    $va1                      = $VA->format('Y/m/d');?>
                ...
                <td><a href="Resultado.php?sol_ID=<?php echo $row['sol_id']; ?>">
                  <span class="codigo">
        ...
        <tr>
          ...
          <td><?php echo $row['servicio']; ?></td>
            ...
            <?php if ($row['plo_id']=='' || $row['plo_id']==$id_) {?>
              ...
              <a href="Resultado.php?sol_ID=<?php echo $row['sol_id']; ?>&%20id_=<?php echo $id_; ?>&%20lote=<?php echo $row['lote']; ?>&%20Servicios=<?php echo $row['servicio']; ?>">
